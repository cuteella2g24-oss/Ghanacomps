  ...
  return (
    <>
      ...
      <div className="page-header">
        ...
        <p className="lead" style={{ marginTop: 'var(--space-md)' }}>When Ghana play this is where you come. Before the game we give you what to expect. During the game we post every goal on X as it happens. After the final whistle we break it all down.</p>
      </div>

      {/* EDITOR SECTION */}
      <section>
        <Editable tag="div" eid="bs-eyebrow" className="eyebrow">Latest Update</Editable>
        <h2 className="d2" style={{ marginBottom: 'var(--space-4xl)' }}><Editable tag="span" eid="bs-title" className="gold">Otto Addo Sacked. New Chapter Begins.</Editable></h2>
      ...
      <section className="alt">
        ...
        <h2 className="d2" style={{ marginBottom: 'var(--space-5xl)' }}>Next <span className="gold">Fixtures.</span></h2>
        <div className="g2">
      ...
      <section>
        ...
        <h2 className="d2" style={{ marginBottom: 'var(--space-xs)' }}>What We <span className="gold">Cover.</span></h2>
      ...
      <section className="alt">
        ...
        <h2 className="d2" style={{ marginBottom: 'var(--space-sm)' }}>Player <span className="gold">Archive.</span></h2>
